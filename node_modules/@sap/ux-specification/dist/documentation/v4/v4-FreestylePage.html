...
<script>
    var floorPlanIcon;
    var treeData = {"name":"FreestylePage","description":"SAP Fiori elements for OData V4<br>@sap/ux-specification version 1.120.4","type":"schema","children":[{"name":"$filePath","children":[],"type":"string"}]};
